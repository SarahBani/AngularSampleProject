...
namespace Core.DomainServices
{
    public static class Extension
    {
        ...
        public static TEntity CorrectCharacters<TEntity, TKey>(this TEntity entity)
            where TEntity : Entity<TKey>
        {
            return entity.CorrectCharCode<TEntity, TKey>(true);
        }

        public static TEntity CorrectCharCode<TEntity, TKey>(this TEntity entity, bool hasTrim = false)
            where TEntity : Entity<TKey>
        {
            ...
            foreach (var prop in properties) // Loop through properties
            {
                ...
                var newPropValue = Convert.ChangeType(propertyValue.ToString(), propertyType);
